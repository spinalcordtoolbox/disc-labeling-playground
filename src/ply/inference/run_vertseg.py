...
import monai
from monai.inferers.utils import _create_buffered_slices, _get_scan_interval, _flatten_struct, _pack_struct
...
def sliding_window_inference(
    ...
    **kwargs: Any,
    ...
    """
    Copied from https://github.com/Project-MONAI/MONAI/tree/dev/monai/inferers
