...
def get_parser():
    ...
    parser.add_argument('--crop-size', type=tuple_type_int, default=(96, 384, 192), help='Training crop size in RSP orientation(default=(128, 384, 256)).')
    ...
    parser.add_argument('--pixdim', type=tuple_type_float, default=(1.0, 0.75, 0.75), help='Training resolution in RSP orientation (default=(1.65, 0.75, 0.75)).')
