...
def get_parser():
    ...
    parser.add_argument('--schedule', type=tuple_type_float, default=tuple([(i+1)*0.2 for i in range(4)]), help='Fraction of the max epoch where the learning rate will be reduced of a factor gamma (default=(0.2, 0.4, 0.6, 0.8)).')
